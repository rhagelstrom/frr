...
#define ZEBRA_ROUTE_ALL                  23
#define ZEBRA_ROUTE_MAX                  24

#define SHOW_ROUTE_V4_HEADER \
  "Codes: K - kernel route, C - connected, S - static, R - RIP,%s" \
  "       O - OSPF, I - IS-IS, B - BGP, P - PIM, E - EIGRP, N - NHRP,%s" \
  "       T - Table, v - VNC, V - VNC-Direct, A - Babel,%s" \
...
#define SHOW_ROUTE_V6_HEADER \
  ...
  "       v - VNC, V - VNC-Direct, A - Babel,%s" \
  "       > - selected route, * - FIB route%s%s", \
  VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE

/* babeld */
#define FRR_REDIST_STR_BABELD \
  "<kernel|connected|static|rip|ripng|ospf|ospf6|isis|bgp|pim|eigrp|nhrp|table|vnc>"
...
#define FRR_IP_REDIST_STR_BABELD \
  "<kernel|connected|static|rip|ospf|isis|bgp|pim|eigrp|nhrp|table|vnc>"
...
#define FRR_REDIST_STR_BGPD \
  "<kernel|connected|static|rip|ripng|ospf|ospf6|isis|pim|eigrp|nhrp|table|vnc|vnc-direct|babel>"
...
#define FRR_IP_REDIST_STR_BGPD \
  "<kernel|connected|static|rip|ospf|isis|pim|eigrp|nhrp|table|vnc|vnc-direct|babel>"
...
#define FRR_IP6_REDIST_STR_BGPD \
  "<kernel|connected|static|ripng|ospf6|isis|nhrp|table|vnc|vnc-direct|babel>"
...
#define FRR_REDIST_STR_EIGRPD \
  "<kernel|connected|static|rip|ospf|isis|bgp|pim|nhrp|table|vnc|babel>"
...
#define FRR_REDIST_STR_ISISD \
  "<kernel|connected|static|rip|ripng|ospf|ospf6|bgp|pim|eigrp|nhrp|table|vnc|babel>"
...
#define FRR_IP_REDIST_STR_ISISD \
  "<kernel|connected|static|rip|ospf|bgp|pim|eigrp|nhrp|table|vnc|babel>"
...
#define FRR_IP6_REDIST_STR_ISISD \
  "<kernel|connected|static|ripng|ospf6|bgp|nhrp|table|vnc|babel>"
...
#define FRR_REDIST_STR_NHRPD \
  "<kernel|connected|static|rip|ripng|ospf|ospf6|isis|bgp|pim|eigrp|table|vnc|babel>"
...
#define FRR_IP_REDIST_STR_NHRPD \
  "<kernel|connected|static|rip|ospf|isis|bgp|pim|eigrp|table|vnc|babel>"
...
#define FRR_IP6_REDIST_STR_NHRPD \
  "<kernel|connected|static|ripng|ospf6|isis|bgp|table|vnc|babel>"
...
#define FRR_REDIST_STR_OSPF6D \
  "<kernel|connected|static|ripng|isis|bgp|nhrp|table|vnc|babel>"
...
#define FRR_REDIST_STR_OSPFD \
  "<kernel|connected|static|rip|isis|bgp|pim|eigrp|nhrp|table|vnc|babel>"
...
#define FRR_REDIST_STR_RIPD \
  "<kernel|connected|static|ospf|isis|bgp|pim|eigrp|nhrp|table|vnc|babel>"
...
#define FRR_REDIST_STR_RIPNGD \
  "<kernel|connected|static|ospf6|isis|bgp|nhrp|table|vnc|babel>"
...
#define FRR_IP_PROTOCOL_MAP_STR_ZEBRA \
  "<kernel|connected|static|rip|ospf|isis|bgp|pim|eigrp|nhrp|table|vnc|babel|any>"
...
#define FRR_IP6_PROTOCOL_MAP_STR_ZEBRA \
  "<kernel|connected|static|ripng|ospf6|isis|bgp|nhrp|table|vnc|babel|any>"
